...
class ForwardDeformer(torch.nn.Module):
    ...
    def forward(self, xd, cond, tfs, mask=None, eval_mode=False, init_weights=None):
        ...
        if init_weights is not None:
            ...
            xc_init = self.__init(xd, tfs, init_weights)
        else:
    ...
    def __init(self, xd, tfs, init_weights=None):
